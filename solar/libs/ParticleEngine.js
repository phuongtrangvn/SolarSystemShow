...
ParticleEngine.prototype.initialize = function(app)
{
	...
	app.scene.add( this.particleMesh );
}
...
ParticleEngine.prototype.destroy = function(app)
{
    app.scene.remove( this.particleMesh );
}
///////////////////////////////////////////////////////////////////////////////
